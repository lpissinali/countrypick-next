(function() {
  ...
  document.querySelectorAll('.mw-mode-switch button').forEach(btn => {
    btn.addEventListener('click', () => { document.querySelectorAll('.mw-mode-switch button').forEach(b => b.classList.remove('active')); btn.classList.add('active'); state.mode = btn.dataset.mode; });
  });
  document.querySelectorAll('.mw-format-switch button').forEach(btn => {
    btn.addEventListener('click', () => { document.querySelectorAll('.mw-format-switch button').forEach(b => b.classList.remove('active')); btn.classList.add('active'); state.format = btn.dataset.format; });
  });
