...
const HistoricalPage: NextPage<Props> = ({ lang, t, continents, activeLangs }) => {
  ...
  return (
    <CategoryPage
      ...
      seo={{
        ...
        ogImage: 'https://ik.imagekit.io/bwvxkqzwak0rq/static/img/gallery/hu.jpg?v=2',
        ogImageAlt: title,
        ...
        jsonLd: pageJsonLd({
          ...
          breadcrumbs: [
            ...
            { name: t['historical_cities'] ?? 'Historical Cities', item: canonical },
          ],
        }),
      }}
      heroImg="hu.jpg"
